...
<body>
  ...
  <?php
    ...
    <div class='img-container'>
      <img src='{$products["CATEGORY"] [1]["data"][0]["SLIKA"]}'>
    </div>
    <div class='product-info'>
      <div class='product-content'>
        <h1>{$products["CATEGORY"] [1]["data"][0]["NAZIV"]}</h1>
        <p>{$products["CATEGORY"] [1]["data"][0]["OPIS"]}</p>
        <div class='buttons'>
          <a class='button buy' href='singleProductPage.php?IDProduct={$products["CATEGORY"] [1]["data"][0]["IDPROIZVOD"]}'>DODAJ PONUDU ZA OVAJ PROIZVOD</a>
          <br>
          <br>
          <span class='button' id='price'>{$products["CATEGORY"] [1]["data"][0]["POCETNACENA"]},00 RSD</span>
        </div>
      </div>
    </div>
  </div>
